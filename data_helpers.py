...
class Data:
    ...
    def read(self, filename):
        ...
        filename = 'C:/Users/yhe/Desktop/논문/Fake_news-master/Fake_news-master/data/mission1_train.csv'
        rows = []
        # Process file
        with open(filename, 'r', encoding='utf8' ) as table:
            r = DictReader(table)
            for line in r:
                rows.append(line)
        return rows
...
def load_word_embedding(file_name, vocab_processor, embedding_dim):
    ...
    file_name = 'C:/Users/yhe/Desktop/논문/Fake_news-master/Fake_news-master/train/fasttext_3_10/fasttext_3_10.vec'
